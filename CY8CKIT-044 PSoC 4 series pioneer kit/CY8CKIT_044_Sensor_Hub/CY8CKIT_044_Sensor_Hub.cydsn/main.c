/*****************************************************************************
* Project Name		: CY8CKIT_044_Sensor_Hub
* Version			: 1.0
...
* location information of data in F-RAM. 
*
...
void Initialize_Project(void)
{
	 ...
	 * CY8CKIT_044_Sensor_Hub.cydwr. The WatchDog Timer2 is configured to
	 * generate an interrupt every 1 second. */
